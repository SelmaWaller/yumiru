...
const day = {
  ...
  buttonShadow: `0 13px 30px -15px ${variables.sunLinkOrange}c2, 0 13px 30px -15px ${variables.sunLinkPink}c2`,
  buttonSecondary: variables.sunButtonSecondary,
  buttonShadowSecondary: `0 13px 30px -15px ${variables.sunLinkBlue}c2, 0 13px 30px -15px ${variables.sunLinkTurquoise}c2`,
  ...
  globalScroll: variables.sunScroll,
  globalScrollHover: variables.sunScrollHover,
  //date and time
...
const evening = {
  ...
  buttonShadow: `0 13px 30px -15px ${variables.moonLinkOrange}40, 0 13px 30px -15px ${variables.moonLinkPink}40`,
  buttonSecondary: variables.moonButtonSecondary,
  buttonShadowSecondary: `0 13px 30px -15px ${variables.moonLinkBlue}40, 0 13px 30px -15px ${variables.moonLinkTurquoise}40`,
  ...
  globalScroll: variables.moonScroll,
  globalScrollHover: variables.moonScrollHover,
  //date and time
  ...
  //footer
  footer: variables.moonShadowDark,
};
