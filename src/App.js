...
const day = {
  ...
  buttonShadowSecondary: `0 13px 30px -15px ${variables.sunLinkBlue}c2, 0 13px 30px -15px ${variables.sunLinkCyan}c2`,
...
const evening = {
  ...
  buttonShadowSecondary: `0 13px 30px -15px ${variables.moonLinkBlue}40, 0 13px 30px -15px ${variables.moonLinkCyan}40`,
